...
import xnx.Session.CategoryFacade;
...
public class CategoryController implements Serializable {
    ...
    @EJB
    private xnx.Session.CategoryFacade ejbFacade;
    ...
    public PaginationHelper getPagination() {
        if (pagination == null) {
            pagination = new PaginationHelper(10) {  //define the pagesize=10

                @Override
                public int getItemsCount() {  // override the function in PaginationHelper
                    return getFacade().count(); //get the CategorFacade and then invoke the count() method 
                                                //in the super class - AbstractFacade 
                }                               
