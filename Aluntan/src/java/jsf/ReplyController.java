...
public class ReplyController implements Serializable {
    ...
    @EJB
    private jsf.ReplyFacade ejbFacade;
   ...
   public String MygetReply(String string){
       
       current=(Reply)getItems().getRowData();
      if(current.getPost().getPostPK().getPostName().equals(string)){
       return current.getReplyContent();
    ...
    public Reply getReply(java.lang.Integer id) {
    ...
    public static class ReplyControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Reply) {
                ...
                return getStringKey(o.getReplyId());
            } else {
